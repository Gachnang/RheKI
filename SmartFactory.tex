...
\begin{tabular}{p{0.2cm}p{2.5cm}p{8cm}}\toprule
	...
	\label{CheckListe:Fertigungsprozess}FA
	& Fertigungsprozesse automatisiert
...
\begin{tabular}{p{3.2cm}p{8cm}}\toprule
  TODO & TODO \\\midrule
  TODO & TODO\\\midrule
  TODO & TODO\\\bottomrule
\end{tabular}

\Block{Spiele}
Das Konzept der \SmartFactory\ ist auch in der Spielindustrie angelangt, so gibt es einige Spiele, in welchen man eine \SmartFactory\ realisieren muss. In diesen Spielen werden alle Punkte erfüllt.
\par\medskip
\begin{tabular}{p{3.2cm}p{8cm}}\toprule
  Factorio & TODO \\\midrule
  Satisfactory & TODO\\\midrule
  Autonauts & TODO\\\bottomrule
\end{tabular}
\end{Map}
...
\Block{Fragestellung beantwortet}
Die Antwort ist leider ernüchtern: TODO
